...
///Passsword encrypting
          $teach_password = mysqli_real_escape_string($connection,$_POST['teach_password']);
          ...
          $salt = $row['randSalt']; 
          $teach_password = crypt($teach_password,$salt);
/// ending Passsword encrypting


          $teach_room_no = mysqli_real_escape_string($connection,$_POST['teach_room_no']);
          $teach_dept = mysqli_real_escape_string($connection,$_POST['teach_dept']);
...
///create_teacher_id
          ...
          $query = "SELECT * FROM departments WHERE dept_name= '$teach_dept' ";
          ...
          $query = "SELECT * FROM teachers WHERE teach_dept = '$teach_dept' ORDER BY teach_id DESC LIMIT 1";
...
///ending create teacher id
          ...
          $query = "INSERT INTO teachers(teach_id,teach_name,teach_short_code,teach_password,teach_room_no,teach_dept,teach_email,teach_contact_no,teach_designation,teach_image,teach_current_address,teach_permanent_address,teach_university,teach_qualification) ";

          $query .="VALUES('{$teach_id}','{$teach_name}','{$teach_short_code}','{$teach_password}','{$teach_room_no}','{$teach_dept}','{$teach_email}','{$teach_contact_no}','{$teach_designation}','{$teach_image}','{$teach_current_address}','{$teach_permanent_address}','{$teach_university}','{$teach_qualification}')";
