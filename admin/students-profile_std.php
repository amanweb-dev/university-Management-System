...
<div class="content-page">
    ...
    <div class="content">
      ...
      global $connection;
       if (isset($_GET['s_id']) && isset($_GET['shift'])) {
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                   <div class="std_part_one">
                        ...
                        <?php echo "<td><a href='students-edit_std.php?p_id={$std_id}&shift={$the_std_shift}'><button type='button' class='btn btn-warning btn-block'>Edit</button></a></td>"; ?></br>
                              
                              
                         <?php echo "<td><a href='students-view_std.php?delete={$std_id}&shift={$the_std_shift}'><button type='button' class='btn btn-danger btn-block'>Delete</button></a></td>"; ?>
                   </div>
                </div>
            </div>
